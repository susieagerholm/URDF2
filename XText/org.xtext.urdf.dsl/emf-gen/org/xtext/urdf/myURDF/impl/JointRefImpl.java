 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.urdf.myURDF.impl.JointRefImpl#getFix <em>Fix</em>}</li>
 *   <li>{@link org.xtext.urdf.myURDF.impl.JointRefImpl#getRev <em>Rev</em>}</li>
 *   <li>{@link org.xtext.urdf.myURDF.impl.JointRefImpl#getPris <em>Pris</em>}</li>
 *   <li>{@link org.xtext.urdf.myURDF.impl.JointRefImpl#getCont <em>Cont</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JointRefImpl extends MinimalEObjectImpl.Container implements JointRef {
	...
	protected EClass eStaticClass() {
		return MyURDFPackage.Literals.JOINT_REF;
	}
	...
	public void setFix(String newFix) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyURDFPackage.JOINT_REF__FIX, oldFix, fix));
	}
	...
	public void setRev(String newRev) {
		...
		rev = newRev;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyURDFPackage.JOINT_REF__REV, oldRev, rev));
	}
	...
	public void setPris(String newPris) {
		...
		pris = newPris;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyURDFPackage.JOINT_REF__PRIS, oldPris, pris));
	}
	...
	public void setCont(String newCont) {
		...
		cont = newCont;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyURDFPackage.JOINT_REF__CONT, oldCont, cont));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MyURDFPackage.JOINT_REF__FIX:
				return getFix();
			case MyURDFPackage.JOINT_REF__REV:
				return getRev();
			case MyURDFPackage.JOINT_REF__PRIS:
				return getPris();
			case MyURDFPackage.JOINT_REF__CONT:
				return getCont();
		}
