...
import org.xtext.urdf.parser.antlr.internal.InternalDslLexer;
import org.xtext.urdf.scoping.DslScopeProvider;
import org.xtext.urdf.serializer.DslSemanticSequencer;
import org.xtext.urdf.serializer.DslSyntacticSequencer;
...
public abstract class AbstractDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/urdf/Dsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.urdf.Dsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("urdf");
	}
