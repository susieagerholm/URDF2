 ...
 * <!-- end-user-doc -->
 * @see org.xtext.urdf.domainmodel.DomainmodelPackage#getJointType()
 * @model
 * @generated
 */
public enum JointType implements Enumerator
{
   ...
   * @ordered
   */
  PRISMATIC(3, "Prismatic", "Prismatic");
   ...
   * @ordered
   */
  public static final int REVOLUTE_VALUE = 0;
