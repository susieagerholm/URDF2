		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getJointAccess().getGroup_7(), "rule__Joint__Group_7__0");
					...
					put(grammarAccess.getJointAccess().getLimitAssignment_7_1(), "rule__Joint__LimitAssignment_7_1");
					put(grammarAccess.getJointAccess().getAxisAssignment_8_1(), "rule__Joint__AxisAssignment_8_1");
					put(grammarAccess.getJointAccess().getOriginAssignment_10(), "rule__Joint__OriginAssignment_10");
					put(grammarAccess.getJointAccess().getCallibrationAssignment_11_1(), "rule__Joint__CallibrationAssignment_11_1");
