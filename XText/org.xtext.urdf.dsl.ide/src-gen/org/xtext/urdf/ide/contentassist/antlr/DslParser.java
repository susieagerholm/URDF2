		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRobotAccess().getGroup_5(), "rule__Robot__Group_5__0");
					...
					put(grammarAccess.getJointAccess().getGroup_0(), "rule__Joint__Group_0__0");
					...
					put(grammarAccess.getRobotAccess().getLinkAssignment_4(), "rule__Robot__LinkAssignment_4");
					put(grammarAccess.getRobotAccess().getLinkAssignment_5_1(), "rule__Robot__LinkAssignment_5_1");
					put(grammarAccess.getRobotAccess().getJointAssignment_6_1(), "rule__Robot__JointAssignment_6_1");
					put(grammarAccess.getRobotAccess().getJointAssignment_6_2(), "rule__Robot__JointAssignment_6_2");
					put(grammarAccess.getLinkAccess().getInertialAssignment_1_1(), "rule__Link__InertialAssignment_1_1");
					put(grammarAccess.getLinkAccess().getInertialAssignment_1_2(), "rule__Link__InertialAssignment_1_2");
					put(grammarAccess.getLinkAccess().getVisualsAssignment_2_1(), "rule__Link__VisualsAssignment_2_1");
					put(grammarAccess.getLinkAccess().getVisualsAssignment_2_2(), "rule__Link__VisualsAssignment_2_2");
					put(grammarAccess.getLinkAccess().getCollisionAssignment_3_1(), "rule__Link__CollisionAssignment_3_1");
					put(grammarAccess.getLinkAccess().getCollisionAssignment_3_2(), "rule__Link__CollisionAssignment_3_2");
					put(grammarAccess.getJointAccess().getTypeAssignment_0_1(), "rule__Joint__TypeAssignment_0_1");
					...
					put(grammarAccess.getJointAccess().getOriginAssignment_11(), "rule__Joint__OriginAssignment_11");
					put(grammarAccess.getJointAccess().getCallibrationAssignment_12_1(), "rule__Joint__CallibrationAssignment_12_1");
					put(grammarAccess.getJointAccess().getDynamicsAssignment_13_1(), "rule__Joint__DynamicsAssignment_13_1");
					put(grammarAccess.getJointAccess().getMimicAssignment_14_1(), "rule__Joint__MimicAssignment_14_1");
					put(grammarAccess.getJointAccess().getSafetycontrollerAssignment_15_1(), "rule__Joint__SafetycontrollerAssignment_15_1");
